...
export const twitterNickNameSelector: () => LiveSelector<E, true> = () =>
  querySelector(
    '[data-testid="SideNav_AccountSwitcher_Button"]>div:nth-child(2)>div>div:nth-child(2)>div>span',
  );
...
export const tweetImageFullScreenListSelector: () => LiveSelector<E, true> =
  () =>
    querySelector<E>('[aria-modal="true"][role="dialog"]').querySelectorAll(
      'li[role="listitem"]',
    );

export const tweetImageFullscreenLoadingSelector: () => LiveSelector<E, true> = () =>
